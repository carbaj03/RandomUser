...
public class RandomUserLocalModel extends RealmObject {
    ...
    public RandomUserLocalModel() {
    }

    public RandomUserLocalModel(String gender, NameLocalModel name, LocationLocalModel location, String email,
